...
from src.config import API_DOCKER_MONITORING_PORT, ENV
...
if __name__ == "__main__":
    ...
    port = int(API_DOCKER_MONITORING_PORT)  # Conversion en entier
    ...
    uvicorn.run(
        "src.monitoring.docker-metadata-exporter.app:app",
        host=host,
        port=port,
        reload=False,
        log_level="info"
